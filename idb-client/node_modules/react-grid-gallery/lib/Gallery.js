...
var Gallery = function (_Component) {
    ...
    function Gallery(props) {
        ...
        _this.onDeleteImage = _this.onDeleteImage.bind(_this);
        return _this;
    }
    ...
    _createClass(Gallery, [{
        ...
        key: 'onDeleteImage',
        value: function onDeleteImage(index, event) {
            event.preventDefault();
            if (this.props.onDeleteImage) this.props.onDeleteImage.call(this, index, this.state.images[index]);
        }
    }, {
        key: 'gotoImage',
        ...
        value: function render() {
            ...
            var images = this.state.thumbnails.map(function (item, idx) {
                return _react2.default.createElement(_Image2.default, {
                    ...
                    onDeleteImage: _this2.onDeleteImage,
